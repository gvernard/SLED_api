...
urlpatterns = [
    ...
    path('add-members/<int:pk>',views.GroupAddMembersView.as_view(),kwargs={'mode':'add'},name='group-add-members'),
    path('remove-members/<int:pk>',views.GroupAddMembersView.as_view(),kwargs={'mode':'remove'},name='group-remove-members'),
