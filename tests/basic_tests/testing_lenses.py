...
for lens in existing_obj:
    ...
    same_as_db = Lenses.distance_on_sky(lens.ra,lens.dec,ra0,dec0)
...
lenses = Lenses.accessible_objects.all(sled_user).order_by('ra','dec')
lens0 = lenses[2]

lens1 = lenses[1]
dra = 20.0/3600.0 # needs to be in deg
ddec = 20.0/3600.0 # needs to be in deg
lens1.ra = float(lens0.ra)+dra
lens1.dec = float(lens0.dec)#+ddec
lens1.save()

lens2 = lenses[0]
dra = 10.0/3600.0 # needs to be in deg
ddec = 20.0/3600.0 # needs to be in deg
