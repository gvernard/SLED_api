...
#    path('imaging-delete/<int:pk>',views.ImagingDeleteView.as_view(),name='imaging-delete'),
    ...
    path('imaging-delete/<int:pk>',views.DataDeleteView.as_view(),kwargs={'model':'Imaging'},name='imaging-delete'),
    ...
    path('spectrum-delete/<int:pk>',views.DataDeleteView.as_view(),kwargs={'model':'Spectrum'},name='spectrum-delete'),
    ...
    path('redshift-delete/<int:pk>',views.DataDeleteView.as_view(),kwargs={'model':'Redshift'},name='redshift-delete'),
    ...
    path('generic-image-delete/<int:pk>',views.DataDeleteView.as_view(),kwargs={'model':'GenericImage'},name='generic-image-delete'),
]
