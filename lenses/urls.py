...
from lenses.views import LensDetailView, LensAddView, LensQueryView, LensCollageView, LensUpdateView, LensDeleteView, LensGiveRevokeAccessView, LensMakePrivateView, LensMakePublicView, LensCedeOwnershipView, LensMergeResolutionView
#from . import views
